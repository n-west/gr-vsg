...
# Title: Simple Psk Gen
# Generated: Mon Mar 21 21:32:08 2016
##################################################
...
class simple_psk_gen(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Simple Psk Gen")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Simple Psk Gen")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "simple_psk_gen")
...
def main(top_block_cls=simple_psk_gen, options=None):
